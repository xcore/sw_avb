...
void ptp_server_and_gpio(chanend c_rx, chanend c_tx,
                         chanend ptp_link[],
                         int num_ptp,
...
on stdcore[0]: out buffered port:32 p_aud_dout[4] = {PORT_SDATA_OUT0,
                                                     PORT_SDATA_OUT1,
                                                     PORT_SDATA_OUT2,
                                                     PORT_SDATA_OUT3};


on stdcore[0]: in buffered port:32 p_aud_din[4] = {PORT_SDATA_IN0,
                                                   PORT_SDATA_IN1,
                                                   PORT_SDATA_IN2,
                                                   PORT_SDATA_IN3};
...
par
{
  ...
  { 
    ...
    uip_server(rx_link[1], tx_link[2], 
               xtcp, 2, null, connect_status);
  }
...
void demo(chanend listener_ctl[], chanend talker_ctl[],
          ...
          chanend c_gpio_ctl)
 {
  ...
  mdns_register_service("XMOS/Attero AVB", 
                        "_attero-cfg._udp", 
                        ATTERO_CFG_PORT, "");
