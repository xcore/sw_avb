...
char osc_name_monitor[8] = "monitor";
...
osc_node osc_node_device_monitor = {
...
osc_node osc_node_device_monitor_source = {
   OSC_NODE_DEVICE_MONITOR_SOURCE,
   osc_name_source,
   &osc_node_device_monitor,
   NULL,
...
int set_device_monitor_source(int a0)
{return getset_device_monitor_source(1, REFERENCE_TO a0);}

int get_device_monitor_source(REFERENCE_PARAM(int, a0))
...
void osc_get(osc_node *n, int h[], osc_val a[]) {
  switch (n->id) {
    ...
    case OSC_NODE_DEVICE_MONITOR_SOURCE:
       get_device_monitor_source(&a[0].val.word);break;
