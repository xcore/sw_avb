...
sub Main {
    ...
    print $osc_tree_h "// Autogenerated OSC data\n";
    print $osc_tree_h "#ifndef _osc_tree_h_\n";
    print $osc_tree_h "#define _osc_tree_h_\n"; 
    print $osc_tree_h "#include <xccompat.h>\n";
    
    print $osc_tree_h "\n\n#ifdef __XC__\n#define REFERENCE_TO\n#else\n#define REFERENCE_TO &\n#endif\n\n";

    print $osc_tree_c "// Autogenerated OSC data\n";
    ...
    print $osc_tree_h "$enums\n\n";
    print $osc_tree_h "#ifndef __OSC_IMPL\n\n";
    print $osc_tree_h "$funcs";
    print $osc_tree_h "\n#endif // __OSC_IMPL\n";
    print $osc_tree_h "\n\n";
