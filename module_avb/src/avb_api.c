...
int set_avb_source_format(int h0,enum avb_stream_format_t a0,int a1)
{return getset_avb_source_format(1, h0,REFERENCE_TO a0,REFERENCE_TO a1);}

int get_avb_source_format(int h0,REFERENCE_PARAM(enum avb_stream_format_t, a0),REFERENCE_PARAM(int, a1))
...
int set_avb_sink_format(int h0,enum avb_stream_format_t a0,int a1)
{return getset_avb_sink_format(1, h0,REFERENCE_TO a0,REFERENCE_TO a1);}

int get_avb_sink_format(int h0,REFERENCE_PARAM(enum avb_stream_format_t, a0),REFERENCE_PARAM(int, a1))
