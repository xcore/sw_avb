...
int main(void)
{
  ...
  par
  {
    ...
    on tile[AVB_AUDIO_TILE]: avb_1722_talker(c_ptp[PTP_TO_TALKER],
...
#if AVB_DEMO_ENABLE_LISTENER
    // AVB Listener
    on tile[AVB_AUDIO_TILE]: avb_1722_listener(c_mac_rx[MAC_RX_TO_LISTENER],
                                  c_buf_ctl[0],
                                  null,
                                  c_listener_ctl[0],
                                  AVB_NUM_SINKS);
    ...
    on tile[AVB_GPIO_TILE].core[0]: avb_manager(i_avb, NUM_AVB_MANAGER_CHANS,
                                    i_srp,
                                    c_media_ctl,
                                    c_listener_ctl,
                                    c_talker_ctl,
    ...
    on tile[AVB_GPIO_TILE].core[0]: avb_srp_task(i_avb[AVB_MANAGER_TO_SRP],
                                     i_srp,
                                     c_mac_rx[MAC_RX_TO_SRP],
                                     c_mac_tx[MAC_TX_TO_SRP]);
    on tile[AVB_FLASH_TILE].core[0]: spi_task(i_spi);


    on tile[AVB_AUDIO_TILE].core[0]: application_task(i_avb[AVB_MANAGER_TO_DEMO], i_1722_1_entity);
    on tile[AVB_AUDIO_TILE].core[0]: avb_1722_1_task(otp_ports0,
