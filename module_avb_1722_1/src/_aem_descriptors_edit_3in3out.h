...
unsigned char desc_audio_input_port_0[] =
{
  ...
  U16(3),                                     /* 6-7 audio_channels */
  U16(3),                                     /* 8-9 number_of_clusters */
...
unsigned char desc_audio_cluster_4[] =
{
  U16(AEM_AUDIO_CLUSTER_TYPE),                /* 0-1 descriptor_type */
  U16(4),                                     /* 2-3 descriptor_id */ 
  U16(1),                                     /* 4-5 channel_count */
  U32(0),                                     /* 6-9 path_latency */
  0x40,                                       /* 10-11 am824_label */ 
  "Right",                                    /* 12-75 cluster_name */
...
unsigned char desc_audio_cluster_5[] =
{
  U16(AEM_AUDIO_CLUSTER_TYPE),                /* 0-1 descriptor_type */
  U16(5),                                     /* 2-3 descriptor_id */ 
  U16(1),                                     /* 4-5 channel_count */
  U32(0),                                     /* 6-9 path_latency */
  0x40,                                       /* 10-11 am824_label */ 
  "Third",                                    /* 12-75 cluster_name */
...
unsigned int aem_descriptor_list[] =
{
  ...
  AEM_AUDIO_CLUSTER_TYPE, 6, sizeof(desc_audio_cluster_0), (unsigned)desc_audio_cluster_0, sizeof(desc_audio_cluster_1), (unsigned)desc_audio_cluster_1, sizeof(desc_audio_cluster_2), (unsigned)desc_audio_cluster_2, sizeof(desc_audio_cluster_3), (unsigned)desc_audio_cluster_3, sizeof(desc_audio_cluster_4), (unsigned)desc_audio_cluster_4, sizeof(desc_audio_cluster_5), (unsigned)desc_audio_cluster_5,
