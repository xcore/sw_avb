...
int process_avb_1722_1_aecp_packet(REFERENCE_PARAM(avb_status_t, status), unsigned char dest_addr[6], REFERENCE_PARAM(avb_1722_1_aecp_packet_t, pkt), chanend c_tx);
