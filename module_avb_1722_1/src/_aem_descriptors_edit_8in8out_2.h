...
#define AVB_1722_1_AEM_GENERATE_CLUSTERS_RUNTIME 1
...
unsigned char desc_audio_input_port_0[] =
{
  ...
  U16(8),                                     /* 6-7 audio_channels */
  U16(8),                                     /* 8-9 number_of_clusters */
...
#if (AVB_1722_1_AEM_GENERATE_CLUSTERS_RUNTIME)
...
unsigned char desc_audio_input_map_0[] =
{
  ...
  U16(0),                                     /* mapping_stream_index[2] */
  U16(2),                                     /* mapping_stream_channel[2] */
  U16(2),                                      /* mapping_audio_channel[2] */
  U16(0),                                     /* mapping_stream_index[2] */
  U16(3),                                     /* mapping_stream_channel[2] */
  U16(3),                                      /* mapping_audio_channel[2] */
  U16(0),                                     /* mapping_stream_index[2] */
  U16(4),                                     /* mapping_stream_channel[2] */
  U16(4),                                      /* mapping_audio_channel[2] */
  U16(0),                                     /* mapping_stream_index[2] */
  U16(5),                                     /* mapping_stream_channel[2] */
  U16(5),                                      /* mapping_audio_channel[2] */
  U16(0),                                     /* mapping_stream_index[2] */
  U16(6),                                     /* mapping_stream_channel[2] */
  U16(6),                                      /* mapping_audio_channel[2] */
  U16(0),                                     /* mapping_stream_index[2] */
  U16(7),                                     /* mapping_stream_channel[2] */
  U16(7)                                      /* mapping_audio_channel[2] */
};
...
// See desc_audio_cluster_template[]
...
unsigned char desc_stream_input_0[] =
{
  ...
  U16(8),                                     /* 72-73 stream_channels */
  U16(0),                                     /* 74-75 clock_source_id */
  U64(0x0050020800000000),                    /* 76-83 current_format */
  ...
  /* 130-> formats */
  U64(0x0050020800000000),
  U64(0x0050040800000000),
  U64(0x0050060800000000)
};
...
#if (AVB_1722_1_AEM_GENERATE_CLUSTERS_RUNTIME)
  AEM_AUDIO_CLUSTER_TYPE, 1, sizeof(desc_audio_cluster_template), (unsigned)desc_audio_cluster_template,
#endif
