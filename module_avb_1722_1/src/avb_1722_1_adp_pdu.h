...
#define AVB_1722_1_ADP_ENTITY_CAPABILITIES_ASSOCIATION_ID_SUPPORTED     (0x00000020)
#define AVB_1722_1_ADP_ENTITY_CAPABILITIES_ASSOCIATION_ID_VALID         (0x00000040)
#define AVB_1722_1_ADP_ENTITY_CAPABILITIES_VENDOR_UNIQUE_SUPPORTED      (0x00000080)
