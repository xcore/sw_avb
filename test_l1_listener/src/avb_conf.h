...
// L1 Listener - 1 stream - 2 channel config
...
#define AVB_MAX_CHANNELS_PER_STREAM 2 // TBD

/* Listener configuration */
#define AVB_NUM_SINKS 1
#define AVB_NUM_LISTENER_UNITS 1

#define MAX_AVB_STREAMS_PER_LISTENER 1
...
#define MAX_CLK_CTL_CLIENTS AVB_NUM_MEDIA_CLOCKS
#define MAX_NUM_MEDIA_CLOCKS AVB_NUM_MEDIA_CLOCKS
